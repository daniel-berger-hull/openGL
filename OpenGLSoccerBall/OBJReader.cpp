...
//const char* filePath = "C:\\data\\Programming\\Workspaces\\C++\\3D\\Models\\OBJ\\StreetLamp\\";
...
bool parseFaceString(string nextLine)
{
	...
	// Change the Color object from Point3D to RGB please!!!
...
{
	cout << "  Parsing Texture Coords String...\n";
