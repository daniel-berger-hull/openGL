...
bool MyApp::initModels()
{
	...
	Point3D		lightLocation = { LIGHT_DISTANCE, LIGHT_Y_POS, 0.0f };
	...
	Light3D light({ 100.0f, 50.0f, 0.0f });
...
void MyFrame::buildMainView()
{
	...
	GeneralModel::getInstance()->setControlPanel(m_controlPanel);
	...
	// in the Editor project, but not required here
